...
export function Header() {
  ...
  return (
    <header className="h-16 sticky top-0 z-40 bg-[#000000]/85 backdrop-blur-md border-b border-outline-variant/10 px-6 shrink-0 flex items-center justify-between">
      {/* Search */}
