...
export const SETTINGS_REGISTRY: SettingDefinition[] = [
  ...
  },
  {
    ...
    description: 'Telephony provider for phone calls: twilio, telnyx, plivo, or disabled',
    isSecret: false,
  },
  {
    key: 'voice.publicUrl',
    ...
    valueType: 'string',
    defaultValue: null,
    description: 'Public URL for telephony webhooks (e.g., https://yourdomain.com or ngrok URL). Required for receiving call events.',
    isSecret: false,
  },
  {
  ...
  },
  {
    ...
    valueType: 'json',
    defaultValue: null,
    description: 'Phone numbers allowed for inbound calls (E.164 format). Only used when inboundPolicy is "allowlist".',
    isSecret: false,
  },
  {
    key: 'voice.inboundGreeting',
    category: 'voice',
    valueType: 'string',
    defaultValue: 'Hello, how can I help you?',
    description: 'Greeting message for inbound callers',
    isSecret: false,
  },
  {
