...
A `contract_failed` that reaches you has therefore **already been retried once
and failed again**. Treat it as a real, twice-observed failure: say what failed,
do not re-spawn it yourself.
