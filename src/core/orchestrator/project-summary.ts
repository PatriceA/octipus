...
/**
 * Auto-update .octipus/project-summary.md after pipeline/agent completion.
...
export async function autoUpdateProjectSummary(
  ...
  try {
    ...
    const summaryDir = resolve(projectRoot, '.octipus');
    ...
    // Ensure .octipus/ directory exists — this is the most common failure point
    try {
      mkdirSync(summaryDir, { recursive: true });
    } catch (dirErr) {
      coreLogger.error({ err: dirErr, summaryDir }, 'Failed to create .octipus/ directory for project summary');
      return;
    }
